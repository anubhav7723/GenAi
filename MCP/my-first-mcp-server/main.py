...
# # MCP prompt : without variable
# @mcp.prompt()
# def hr_assistanr() -> str:
#     return """
#     You are on HR assistant. Help employees with leave management professionaly."""

# # MCP prompt : with variable
# @mcp.prompt()
# def employee_support(employee_name: str) -> str:
#     return f"""
#     You are assisting employee {employee_name}.
...
#     return {
#         "message" : f"{data.days} leave days applied for {data.employee_id}"
#     }
